  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          ...
          <label>product_id</label> <input class="form-control" name='bno'
            value='<c:out value="${product.product_id }"/>' readonly="readonly">
        </div>

        <div class="form-group">
          <label>Title</label> <input class="form-control" name='title'
            value='<c:out value="${product.title }"/>' readonly="readonly">
        </div>

        <div class="form-group">
          <label>Text area</label>
          <textarea class="form-control" rows="3" name='content'
            readonly="readonly"><c:out value="${product.product_info}" /></textarea>
        </div>

        <div class="form-group">
          <label>user_id</label> <input class="form-control" name='writer'
...
$(document).ready(function () {
  ...
  var bnoValue = '<c:out value="${product.product_id}"/>';
  var replyUL = $(".chat");
